		...
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					...
					<div class="x_content">
						<br/>
						<form:form modelAttribute="categoryForm" servletRelativeAction="/category/save" method="POST" 
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input path="description" class="form-control col-md-7 col-xs-12" disabled="${viewMode}"/>
									<div class="has-error">
