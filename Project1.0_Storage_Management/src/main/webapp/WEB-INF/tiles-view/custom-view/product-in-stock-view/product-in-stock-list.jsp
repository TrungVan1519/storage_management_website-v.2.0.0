			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="container">	
						...
						<a href="<c:url value="/paging/product-in-stock/list"/>" class="btn btn-success btn-lg">
								...
								<tbody>
									<c:forEach items="${productInStocks}" var="productInStock" varStatus="loop">
										...
										<c:choose>
											...
											<td class=" ">${product.productproductInStocktegory.name }</td>
											<td class=" ">${productInStock.productInfo.code }</td>
											<td class=" ">${productInStock.productInfo.name }</td>
											<td class=" ">
												<img src="<c:url value="${productInStock.productInfo.imageUrl}"/>" width="100px" height="100px"/>
											</td>
