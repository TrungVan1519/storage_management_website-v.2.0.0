			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form:form modelAttribute="invoiceSearchForm" servletRelativeAction="/goods-issue/list" method="POST"
					...
					<div class="container">
						...
						<a href="<c:url value="/goods-issue/add"/>" class="btn btn-success btn-lg">
							Add <i class="fa fa-plus"></i> 
						</a>
						
						<a href="<c:url value="/goods-issue/export"/>" class="btn btn-success btn-lg">
								...
								<tbody>
									<c:forEach items="${invoices}" var="invoice" varStatus="loop">
											...
											<td class="text-center">
												<a href="<c:url value="/goods-issue/view/${invoice.id }"/>" class="btn btn-info">
													View <i class="fa fa-file-text-o"></i> 
												</a>
											</td>
											<td class="text-center">
												<a href="<c:url value="/goods-issue/edit/${invoice.id }"/>" class="btn btn-warning">
