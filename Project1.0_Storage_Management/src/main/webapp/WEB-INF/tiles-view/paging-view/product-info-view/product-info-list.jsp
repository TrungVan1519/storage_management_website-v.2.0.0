			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="container">
						...
						<a href="<c:url value="/product-info/list"/>" class="btn btn-success btn-lg">
...
<script type="text/javascript">
	...
	function gotoPage(page){
		window.location.replace("<c:url value="/paging/product-info/list/"/>" + page);
