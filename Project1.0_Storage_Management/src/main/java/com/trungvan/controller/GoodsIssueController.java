...
public class GoodsIssueController {
	...
	// Retrieve
	/**
	 * > Do trong endpoint /goods-issue/list ta tao san Form tim kiem nen khong can phai tao 1 endpoint khac
	 * 		de show Form
	 * > Do khi truy van binh thuong den /goods-issue/list su dung GET, nhung neu tim kiem productInfo thi truy
	 * 		van den /goods-issue/list su dung POST nen o day khong chi dinh cu the @GetMapping hay @PostMapping duoc
	...
	public String showInvoiceList(Model model, HttpSession session,
		...
		return "goodsIssueListView.definition";
	}
	...
	public String showSingleInvoice(Model model,
		...
		if(invoice != null) {
			...
			return "goodsIssueAction.definition";
		}
	...
	public ModelAndView exportReport() {
		...
		//		chi can invoice.setType(Constant.TYPE_GOODS_ISSUES), con cac field thi khong quan trong
